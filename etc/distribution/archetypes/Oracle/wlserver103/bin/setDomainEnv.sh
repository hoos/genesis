...
WL_HOME="/Users/mikemochan/dev/bea/wls103/wlserver_10.3"
export WL_HOME

BEA_JAVA_HOME=""
export BEA_JAVA_HOME

SUN_JAVA_HOME="/Users/mikemochan/dev/soylatte16-i386-1.0.2"
...
if [ "${JAVA_VENDOR}" = "BEA" ] ; then
	...
	if [ "${JAVA_VENDOR}" = "Sun" ] ; then
		...
		JAVA_VENDOR="Sun"
		export JAVA_VENDOR
		JAVA_HOME="/Users/mikemochan/dev/soylatte16-i386-1.0.2"
		export JAVA_HOME
	fi
fi
...
LONG_DOMAIN_HOME="/Users/mikemochan/dev/bea/wls103/user_projects/domains/base_domain"
