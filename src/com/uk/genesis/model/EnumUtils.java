...
public final class EnumUtils {
	public static GenesisObject[] enumerateChildObjectsOfType(GenesisObject current, GenesisObjectType desiredType) 
	...
	public static GenesisObject[] enumerateChildObjectsOfType(GenesisObject parentParentInstance, GenesisObjectType[] possibleParents, GenesisObjectType desiredType) 
			throws ModelException {
	...
	public static GenesisObjectType findRelevantParent(GenesisObjectType[] types, GenesisObjectType child) 
			throws ModelException {
