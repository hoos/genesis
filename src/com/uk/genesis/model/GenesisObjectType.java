...
public interface GenesisObjectType {
    ...
    /**
     * Retrieves the qualified name of this genesis
     * object type. For example, /parent/child.
     * @return the qualified name.
     */
    String getQualifiedName();

    /**
     * Retrieves an instance of the defined object, based on
     * the given pathing information. The pathing information
     * should be in the form of /&lt;parent&gt;/&lt;child&gt;
    ...
    /**
     * Retrieves all child instances of this type rooted underneath
     * the given parent. Note that the provided parent must be either
     * null (if this is a root object), or of a direct parent type.
     * @param parent null if this is a root type,
     * or an instance of a direct parent type.
