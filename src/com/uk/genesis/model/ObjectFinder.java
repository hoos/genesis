...
public final class ObjectFinder {
    public static String[] findObjectNames(final File basePath, final String path, final String name) {
    ...
    private static String findName(final String pattern, final String found) {
