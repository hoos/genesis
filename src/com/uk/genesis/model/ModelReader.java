...
/**
 * Interface providing programatic access to a model
 * defined in the primary genesis configuration file.
 *
 * @author paul.jones
 */
public interface ModelReader {
    ...
    /**
     * Requests a single GenesisObjectType, using xpath style
     * syntax. For example, finding an object Cabinet that has
     * a parent tree of Datacentre, then Enterprise, the expression
     * /Enterprise/Datacentre/Cabinet would be used.
    ...
    /**
     * Retrieves the location of any global configuration data
     * for the genesis instance. Note that this may null if there
     * is no global configuration configured, or if the object model
