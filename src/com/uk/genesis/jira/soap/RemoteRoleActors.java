...
public class RemoteRoleActors  implements java.io.Serializable {
    private com.uk.genesis.jira.soap.RemoteProjectRole projectRole;

    private com.uk.genesis.jira.soap.RemoteRoleActor[] roleActors;

    private com.uk.genesis.jira.soap.RemoteUser[] users;

    public RemoteRoleActors() {
    }

    public RemoteRoleActors(
           com.uk.genesis.jira.soap.RemoteProjectRole projectRole,
           com.uk.genesis.jira.soap.RemoteRoleActor[] roleActors,
           com.uk.genesis.jira.soap.RemoteUser[] users) {
     ...
     * @return projectRole
     */
    public com.uk.genesis.jira.soap.RemoteProjectRole getProjectRole() {
        return projectRole;
    }
     ...
     * @param projectRole
     */
    public void setProjectRole(com.uk.genesis.jira.soap.RemoteProjectRole projectRole) {
        this.projectRole = projectRole;
    }
     ...
     * @return roleActors
     */
    public com.uk.genesis.jira.soap.RemoteRoleActor[] getRoleActors() {
        return roleActors;
    }
     ...
     * @param roleActors
     */
    public void setRoleActors(com.uk.genesis.jira.soap.RemoteRoleActor[] roleActors) {
        this.roleActors = roleActors;
    }
     ...
     * @return users
     */
    public com.uk.genesis.jira.soap.RemoteUser[] getUsers() {
        return users;
    }
     ...
     * @param users
     */
    public void setUsers(com.uk.genesis.jira.soap.RemoteUser[] users) {
        this.users = users;
    }
