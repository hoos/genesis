...
public class RemotePermissionMapping  implements java.io.Serializable {
    private com.uk.genesis.jira.soap.RemotePermission permission;

    private com.uk.genesis.jira.soap.RemoteEntity[] remoteEntities;

    public RemotePermissionMapping() {
    }

    public RemotePermissionMapping(
    		com.uk.genesis.jira.soap.RemotePermission permission,
    		com.uk.genesis.jira.soap.RemoteEntity[] remoteEntities) {
     ...
     * @return permission
     */
    public com.uk.genesis.jira.soap.RemotePermission getPermission() {
        return permission;
    }
     ...
     * @param permission
     */
    public void setPermission(com.uk.genesis.jira.soap.RemotePermission permission) {
        this.permission = permission;
    }
     ...
     */
    public com.uk.genesis.jira.soap.RemoteEntity[] getRemoteEntities() {
        return remoteEntities;
    }
     ...
     */
    public void setRemoteEntities(com.uk.genesis.jira.soap.RemoteEntity[] remoteEntities) {
        this.remoteEntities = remoteEntities;
    }
