...
public interface GenesisObject {
	...
	/**
	 * Retrieves a file containing the content of this object. Note that
	 * this may return null if there is no file connected to the given schema
	 * object, or if the model is stored in a non-file based system (such as
	 * a CMDB).
	...
	/**
	 * Retrieves the content connected to this object as a series of name value pairs.
	...
	/**
	 * Requests that the object provide a list of all of its children of the given
	 * type.
	 * @return the list of children.
	 * @throws IllegalArgumentException if the given type is not a direct child of this
	 *   objects type.
	 */
	...
	/**
	 * Requests that the object perform any self validation that it can to ensure the integrity
	 * of its configuration.
	 * @throws GenesisObjectValidationException if the object does not validate successfully. 
	 */
	void validate()
