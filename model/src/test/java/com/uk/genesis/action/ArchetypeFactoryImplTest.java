...
public class ArchetypeFactoryImplTest extends TestCase {
	...
	public void testFactoryItemHasBuildFile() throws Exception {
		...
		assertEquals(new File("src/test/etc/archetypes/MyEnterprise-00/MyApplication-00/build-MyApplication-00.xml").getAbsoluteFile(), 
				action.getBuildFile());
	}
