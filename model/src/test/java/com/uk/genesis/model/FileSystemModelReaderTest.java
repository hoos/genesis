...
public class FileSystemModelReaderTest extends TestCase {
	...
	public void testRequestingRootObjectInstancesReturnsValidObjects() throws Exception {
		...
		GenesisObject[] enterprises = enterprise.getAllChildInstances(null);
	...
	public void testReaderLoadsGlobalConfig() throws Exception {
		...
		assertEquals(new File("src/test/etc/config/common.xml").getAbsolutePath(),
	...
	public void testReaderLoadsGlobalContentProperties() throws Exception {
            ...
            assertNotNull(props.getProperty("<Name>GlobalValue1</Name>"));
	}
	...
	public void testFoundObjectInstanceHasFileAssociated() throws Exception {
		...
		assertEquals(
				new File("src/test/etc/config/MyEnterprise-00/physical/MyDatacentre-00/MyRack-00/rack.xml").getAbsoluteFile(), 
	...
	public void testFoundObjectInstanceCanListChildren() throws Exception {
		...
		assertEquals(
				new File("src/test/etc/config/MyEnterprise-00/physical/MyDatacentre-00/MyRack-01/rack.xml").getAbsoluteFile(),
	...
	private ModelReader getReader() throws Exception {
		...
		loader.load("src/test/etc/genesis-structured.xml");
